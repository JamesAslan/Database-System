...
<th class="text-left">station1</th>
<th class="text-left">station2</th>
...
echo $user;
$query = "select OrderID, Orders.StartDate, TS1.StationName, TS2.StationName, Sum(OrderPrice), Status, Orders.TrainID
...
where TS1.OuterStationID = Orders.StartStationOuterID and
        ...
        Orders.UserId = '$user' 
group by OrderID, Orders.StartDate, TS1.StationName, TS2.StationName, Status, Orders.TrainID
order by OrderID;";
